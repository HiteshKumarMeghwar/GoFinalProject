...
function EditPost() {
    ...
    const onSubmit = (data) => {
        ...
        const body = {
            ...data,
            image: imageUpload ? imageUpload : singlePost?.image,
        }
    ...
    const uploadImage = () => {
        ...
        formData.append("image", imageUpload ? imageUpload : singlePost?.image); // append the value with key, value pair
        formData.append("name", imageUpload ? imageUpload.image : singlePost?.image);
        const config = {
