          ...
          <div className='text-center'>
            ...
            <div className='mt-5 sm:mt-8 sm:flex justify-center'>
              <div className='rounded-md shadow'>
                <a href="/create_post" className='w-full flex items-center justify-center px-8 py-3 border border-transparent bg-indigo-600'>Create Post</a>
              </div>
              <div className='mt-3 sm:mt-0 sm:ml-3'>
                <a href="/personal" className='w-full flex items-center justify-center px-8 py-3 border border-transparent bg-indigo-600 '>View My Post</a>
              </div>
            </div>
          </div>
        </main>
